module.exports = {
	name: 'mutedvoice',
	description: 'mutea a una persona de los canales de voz',
  guildOnly: true,
  enabled: true,
  authlevel: 2,
    ...
    if(usr != null){
      ...
      const warnmsg = {
	      color: yellow,
	      title: 'Atención',
	      description: 'Has sido muteado por el mal uso de los canales de voz. Pon un tiquet para reclamar en <#703958300219146250>',
	      timestamp: new Date(),
	      footer:{
		 text: 'Valorant Bot',
	      },
      ...
      const infoembed = {
        ...
        description: '!mutedvoice ``<@usuario>`` ``[motivo]``',
        timestamp: new Date(),
        footer: {
          text: 'Valorant Bot',
        },
